--[[
MabnWriteCount = MabnWriteCount or 0
...
local M = {}
M.on_write = function()
    MabnWriteCount = MabnWriteCount + 1
end
M.set_write = function(count)
    MabnWriteCount = count
end
local autocmd = vim.api.nvim_create_autocmd 
local augroup = vim.api.nvim_create_augroup
local status_group = augroup('MabnStatusLine', {}) 
autocmd('MabnStatusLineCmd', { 
    group = status_group, 
    pattern = '*', 
    callback = function() 
        M.on_write()
